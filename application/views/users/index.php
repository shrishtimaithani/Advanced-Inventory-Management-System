      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <?php if(in_array('createUser', $user_permission)): ?>
            <a href="<?php echo base_url('users/create') ?>" class="btn btn-primary">Add Section Holder</a>
            <br /> <br />
          <?php endif; ?>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Manage Section Holders</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  ...
                  <?php if($user_data): ?>
                    <?php foreach ($user_data as $k => $v): ?>
                      <tr>
                        ...
                        <td><?php echo $v['user_info']['firstname']; ?></td>
