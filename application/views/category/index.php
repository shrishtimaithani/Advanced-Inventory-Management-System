      ...
      <form role="form" action="<?php echo base_url('category/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="category_name" name="category_name" placeholder="Enter location name" autocomplete="off">
          </div>
          <div class="form-group">
            <label for="active">Transfer Type</label>
            <select class="form-control" id="active" name="active">
              <option value="1">Through Invoice</option>
